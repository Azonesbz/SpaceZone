...
export default function Register({
    ...
    return(
        <>
            <section className="flex flex-col items-center justify-end min-h-screen sm:p-10">
                {fieldError ? 
                <div className="flex flex-col items-center absolute z-50 inset-0 h-28 w-full bg-slate-200 p-2 shadow">
                    <h3 className="text-red-600 font-semibold text-center mt-2">Tout les champs doivent être rempli avant de pouvoir vous inscrire.</h3>
                    <button
                ...
                <div className="flex items-center justify-between w-full absolute top-5 px-5">
                    ...
                    <Link className="p-1 text-right underline text-xs font-semibold cursor-pointer" to="/home">Continuer en tant qu'invité</Link>
                </div>
                <div className="absolute top-28">
                    <h1 className="text-5xl lg:text-6xl font-fine font-semibold text-center"><span className="text-5xl text-blue-800">SpaceZone</span>, aller toujours plus loin, aller toujours plus vite.</h1>
                </div>
                <div className="flex flex-col space-y-5 sm:w-2/4 md:w-2/5 lg:w-2/6">
                    ...
                    >
                        ...
                        <button className="flex justify-center items-center py-2 px-5 bg-gradient-to-br from-blue-600 to-blue-700 text-white" id="register">S'inscrire
                            {loader ?
