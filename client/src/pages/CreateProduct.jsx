        ...
        <Modal onClose={onClose} isOpen={isOpen} width={'w-full'} height={'h-72'}>
            <div className='h-full w-full flex flex-col items-center justify-center p-10'>
                <div className='flex flex-col items-center'>
                    ...
                    <h1 className='text-center font-Lato text-xl font-bold'>Vous n'avez pas rempli tout les champs, veuillez remplir le formulaire dans sa totalité avant de le soumettre.</h1>
                </div>
                <button
...
export default function CreateProduct(){
    ...
    return (
        <>
            ...
            <section className="flex min-h-screen mt-10 container col-span-12 font-Lato sm:p-10" id="start-now">
                <div>
